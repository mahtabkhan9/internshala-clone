...
const FiltersSidebar = ({ filters, setFilters, isMobileOpen, setIsMobileOpen }) => {
  ...
  const renderFilterFields = (isMobile) => (
    <>
      <div className="mb-4">
      ...
      {isMobile ? (
        <div className="flex justify-between items-center mb-6 mt-4">
          ...
          <button
            ...
            className="bg-[#00a5ec] text-white px-8 py-2 rounded-[4px] font-medium text-[14px] hover:bg-[#008bdc] transition-colors"
          >
            Apply
          </button>
        </div>
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-[60] bg-white flex flex-col md:hidden">
          ...
          <div className="flex items-center justify-between px-4 py-4 border-b border-[#eeeeee]">
            <span className="flex-1 text-center font-semibold text-[#333] text-[16px] pl-6">Filters</span>
            <button 
              onClick={() => setIsMobileOpen(false)} 
              className="text-[#484848] text-2xl font-light hover:text-black cursor-pointer"
            >
              &times;
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-5">
            ...
            <hr className="border-[#eeeeee] my-8 -mx-5" />
